...
public class CPU {
    public static int doMove(JButton btn1, JButton btn2, JButton btn3, JButton btn4, JButton btn5, JButton btn6, JButton btn7, JButton btn8, JButton btn9) {
        ...
        if(btn1.getText().equals("O") && btn2.getText().equals("O") && btn3.getText().equals(""))
            ...
            return 3; 
        else if(btn6.getText().equals("X") && btn5.getText().equals("O") && btn8.getText().equals("X") && btn1.getText().equals("")) 
            return 8; 
        else if(btn1.getText().equals("O") && btn5.getText().equals("X") && btn9.getText().equals("X") && btn7.getText().equals("")) 
            return 6; 
        else if(btn3.getText().equals("X") && btn8.getText().equals("X") && btn1.getText().equals("") && btn7.getText().equals("")) 
            return 9;
